...
from kora.kernel import Kernel, Message, Model, ModelResponse
from kora.kernel.types import ToolCall, ToolResult
from kora.runtime.agent import AgentDefinition
...
class Run:
    ...
    async def execute(self, user_message: str) -> AsyncIterator[AnyEvent]:
        ...
        """
        from kora.utils.interrupt import is_interrupted, clear_interrupt, InterruptReason
        ...
        try:
            ...
            while iteration < max_iterations:
                ...
                if self.termination_policy:
                    ...
                    from kora.runtime.termination import TerminationState
            ...
            if termination_requested:
                ...
                if self.storage:
                    from kora.host.storage import RunState
    ...
    def _check_and_compress(self) -> AsyncIterator[AnyEvent]:
        ...
        """
        from kora.runtime.compression import CompressionStats
        from kora.runtime.session import SummaryBlock
        from kora.runtime.token_estimator import TokenEstimator
