...
if TYPE_CHECKING:
    ...
    from kora.runtime.compression import CompressionDecision, CompressionResult
...
class SummarizerCompressor:
    ...
    def compress(
        ...
        """
        from kora.kernel import Kernel
        from kora.kernel.types import Message
        from kora.runtime.compression import CompressionResult
