...
from kora.runtime.events import ModelResponded, AnyEvent
...
def _run_repl(
    ...
    """
    from kora.interface.status import DefaultStatusProvider, StatusContext
    from kora.utils.interrupt import clear_interrupt
    ...
    # from kora.interface.activity import start_interrupt_listener
                ...
                if user_input.startswith("/"):
                    ...
                    if command is not None:
                        ...
                        if resolution.status in ("needs_input", "partial"):
                            ...
                            from kora.host.interactions import InteractionRequest, InteractionOption
                            from kora.interface.selector import select_option
