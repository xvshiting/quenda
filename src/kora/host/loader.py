...
def find_builtin_agent(name: str) -> Path | None:
    ...
    kora_dir = package_dir.parent  # src/kora
    src_dir = kora_dir.parent  # src
    project_root = src_dir.parent  # project root

    # Try new layout: agents/<name>/src/kora_code/agent/
    agent_dir = project_root / "agents" / name / "src" / "kora_code" / "agent"
