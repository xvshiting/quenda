...
if TYPE_CHECKING:
    from kora.runtime.agent import Agent, AgentConfig
...
class CompressCommand:
    ...
    def execute(self, args: str, context: CommandContext) -> CommandResult:
        ...
        from kora.runtime.compression import CompressionDecision
...
class SkillCommand:
        ...
        if not skills:
            return CommandResult(
                ...
                message="No skills found in this workspace.\n\n"
                        "Create a skill by adding `.kora/skills/<name>/SKILL.md`",
            )
    ...
    def _list_resources(self, context: CommandContext) -> CommandResult:
        ...
        from kora.host.skill import ResourceResolver
