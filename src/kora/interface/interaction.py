...
from kora.host.interactions import InteractionContext, InteractionOption, InteractionRegistry, InteractionRequest

if TYPE_CHECKING:
    from kora.host.interactions import Interaction
