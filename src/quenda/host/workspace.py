...
class WorkspaceBinding:
    ...
    This represents the binding file at `<workspace>/.quenda/workspace.yaml`.
...
class WorkspaceResolver:
    ...
    PROTECTED_PATHS = frozenset([
        ".quenda/workspace.yaml",
        ".quenda/workspace.json",
    ])
    ...
    def resolve(self, workspace_path: Path, auto_create: bool = True) -> WorkspaceBinding:
        ...
        binding_path = workspace_path / ".quenda" / "workspace.yaml"
    ...
    def _create_binding(self, workspace_path: Path, binding_path: Path) -> WorkspaceBinding:
        ...
        # Ensure .quenda directory exists
    ...
    def get_user_workspace_path(
        ...
        Layout: ~/.quenda/users/<user_id>/agents/<agent_name>/workspaces/<workspace_id>/
    ...
    def get_user_agent_path(self, user: User, agent_name: str) -> Path:
        ...
        Layout: ~/.quenda/users/<user_id>/agents/<agent_name>/
    ...
    def get_user_workspace_skills_path(
        ...
        Layout: ~/.quenda/users/<user_id>/workspaces/<workspace_id>/skills/
